...
PSO::PSO(ID3D12Device * a_device, D3D12_INPUT_LAYOUT_DESC * a_inputLayoutDesc, D3D12_SHADER_BYTECODE* a_pixelShaderBytecode, D3D12_SHADER_BYTECODE* a_vertexShaderBytecode, ID3D12RootSignature* a_rootSignature)
{
    ...
    psoDesc.SampleDesc = *RenderEngine::GetInstance()->GetSampleDesc(); // must be the same sample description as the swapchain and depth/stencil buffer
